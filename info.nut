...
class FMainClass extends GSInfo {
	...
	function GetDate()			{ return "2020-07-16"; }
	...
	function GetSettings() {
		AddSetting({name = "max_distance_between_towns", description = "Maximum distance between towns. Take care with big values (>150)", easy_value = 128, medium_value = 128, hard_value = 128, custom_value = 128, flags = CONFIG_INGAME, min_value = 16, max_value = 512});
		AddSetting({name = "max_connected_towns", description = "Maximum number of town to be connected to each town", easy_value = 5, medium_value = 5, hard_value = 5, custom_value = 5, flags = CONFIG_INGAME, min_value = 1, max_value = 16});
	}
}
